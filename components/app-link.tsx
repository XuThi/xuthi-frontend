...
/**
 * AppLink - Enhanced Next.js Link component with active state and eager prefetching
 */
export const AppLink = ({
    ...
    const isActive =
        strHref &&
        (exactHrefMatch ? pathname === strHref : pathname.startsWith(strHref))
