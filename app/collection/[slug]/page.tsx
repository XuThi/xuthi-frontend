import type { CategoryWithProducts } from "@/lib/api/types";
...
function CollectionHeader({ collection }: { collection: CategoryWithProducts }) {
	return (
...
function CollectionProducts({ collection }: { collection: CategoryWithProducts }) {
