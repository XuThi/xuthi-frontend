...
import { ArrowLeft, Loader2, Package, Truck, CheckCircle, XCircle, Clock } from 'lucide-react';
...
const statusOptions = [
  ...
  { value: 'Shipped', label: 'Đang giao', icon: Truck, color: 'bg-purple-100 text-purple-800' },
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {item.variantDescription && (
                              <div className="text-sm text-muted-foreground">{item.variantDescription}</div>
                            )}
                            <div className="text-xs text-gray-400">SKU: {item.variantSku}</div>
                          </div>
                        </div>
                      </TableCell>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between text-sm text-muted-foreground">
                ...
                <span>{order.paymentMethod === '0' ? 'COD' : 'Chuyển khoản'}</span>
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    {order.shippingWard}, {order.shippingDistrict}<br />
                    {order.shippingCity}
                  </div>
                  {order.shippingNote && (
                    <div className="text-sm text-muted-foreground mt-2">
                      <span className="font-medium">Ghi chú:</span> {order.shippingNote}
                    </div>
                  )}
                </div>
              </div>
