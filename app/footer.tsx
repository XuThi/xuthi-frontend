			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				...
				<div>
					...
					<ul className="space-y-3">
						...
						<li>
							<AppLink href="/chinh-sach-doi-tra" className="text-sm text-gray-400 hover:text-white transition-colors">
								Chính sách đổi trả
							</AppLink>
						</li>
						<li>
							<AppLink href="/huong-dan-chon-co-giay" className="text-sm text-gray-400 hover:text-white transition-colors">
				...
				<div>
					...
					<ul className="space-y-3 text-sm text-gray-400">
						...
						<li className="flex items-start gap-2">
							<svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
								<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
							</svg>
							<a href="https://www.facebook.com/xuthibrand" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
