...
import { trustT } from "@/lib/i18n/translations";
...
const defaultBadges: TrustBadge[] = [
	{ icon: Truck, title: trustT.freeShipping, description: trustT.freeShippingDesc },
	{ icon: Shield, title: trustT.quality, description: trustT.qualityDesc },
	{ icon: RotateCcw, title: trustT.support, description: trustT.supportDesc },
];
